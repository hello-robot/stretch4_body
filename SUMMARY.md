...
## Core Framework
* [Core Architecture](docs/primer_core.md)
* [Robot Client API](docs/primer_robot_client.md)
* [Robot Parameters](docs/primer_robot_params.md)
...
* [Puppet Teleop](docs/primer_puppet_teleop.md)
