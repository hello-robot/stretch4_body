...
rp=stretch4_body.core.robot_params.RobotParams()

user_origin='stretch_user_params.yaml'
user_params = hello_utils.read_fleet_yaml(user_origin)

rep={}
build_rep('param',stretch4_body.core.robot_params.nominal_system_params,'stretch_body.robot_params.nominal_system_params',rep)
